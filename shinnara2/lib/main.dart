...
class StudyCafeApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return ScreenUtilInit(
      designSize: const Size(1920, 1080), // 기본 데스크톱 해상도
      minTextAdapt: true,
        ...
        return MaterialApp(
          ...
          theme: ThemeData(
            colorScheme: ColorScheme.fromSeed(
              seedColor: const Color(0xFF2E7D32), // 스터디카페 느낌의 녹색
          ...
          home: Consumer(
            builder: (context, ref, child) {
              ...
              return authState.isLoggedIn ? const MainLayout() : const LoginScreen();
            },
          ),
        );
      },
