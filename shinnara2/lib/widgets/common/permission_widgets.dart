...
class PermissionBuilder extends ConsumerWidget {
  final Widget Function(BuildContext context, bool hasPermission, PermissionLevel userLevel)
  builder;
  final PermissionLevel required;

  const PermissionBuilder({super.key, required this.builder, required this.required});
...
class PermissionBadge extends ConsumerWidget {
  ...
  const PermissionBadge({super.key, this.showLevel = true, this.showName = true, this.padding});
