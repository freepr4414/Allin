...
class _DashboardPieChartState extends State<DashboardPieChart> with TickerProviderStateMixin {
        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                color: _touchedIndex == index ? color.withValues(alpha: 0.8) : color,
  ...
  List<PieChartSectionData> _generateAnimatedSections(int total) {
    ...
    return List.generate(entries.length, (index) {
      ...
      return PieChartSectionData(
        ...
        title: animatedPercentage > 5 ? '${animatedPercentage.toStringAsFixed(1)}%' : '',
