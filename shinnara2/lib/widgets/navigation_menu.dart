  ...
  Widget _buildMenuGroup(MenuGroup group) {
    ...
    return Card(
      ...
      child: Column(
        children: [
          ListTile(
            leading: Icon(group.icon, size: 24, color: Theme.of(context).colorScheme.primary),
            title: Text(
              group.title,
              style: TextStyle(
...
class MenuGroup {
  ...
  MenuGroup({required this.id, required this.title, required this.icon, required this.children});
}
