                  ...
                  ...openItem.children.map((subItem) {
                    return MouseRegion(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          onTap: () => _selectSubMenuItem(openItem.id, subItem.id),
                          hoverColor: Colors.white.withValues(alpha: 0.15), // 호버 효과
                          splashColor: Colors.white.withValues(alpha: 0.25), // 클릭 효과
                          highlightColor: Colors.white.withValues(alpha: 0.1), // 하이라이트 효과
