...
class RouteRegistry {
  static final Map<String, RouteDefinition> _routes = {
    ...
    'member_register': RouteDefinition(
      id: 'member_register',
      title: '회원 등록',
      builder: () => const _PlaceholderScreen(title: '회원 등록', subtitle: '신규 회원 등록 화면입니다.'),
    ...
    'general': RouteDefinition(
      id: 'general',
      title: '일반 설정',
      builder: () => const _PlaceholderScreen(title: '일반 설정', subtitle: '기본 시스템 설정을 관리합니다.'),
      requiredLevel: PermissionLevel.level3,
    ...
    'seat_config': RouteDefinition(
      id: 'seat_config',
      title: '좌석 설정',
      builder: () => const _PlaceholderScreen(title: '좌석 설정', subtitle: '좌석 관련 설정을 관리합니다.'),
    ...
    'notification': RouteDefinition(
      id: 'notification',
      title: '알림 설정',
      builder: () => const _PlaceholderScreen(title: '알림 설정', subtitle: '알림 및 메시지 설정을 관리합니다.'),
      requiredLevel: PermissionLevel.level3,
    ...
    'system_settings': RouteDefinition(
      id: 'system_settings',
      title: '시스템 설정',
      builder: () => const _PlaceholderScreen(title: '시스템 설정', subtitle: '고급 시스템 설정을 관리합니다.'),
    ...
    'user_management': RouteDefinition(
      id: 'user_management',
      title: '사용자 관리',
      builder: () => const _PlaceholderScreen(title: '사용자 관리', subtitle: '사용자 및 권한을 관리합니다.'),
      requiredLevel: PermissionLevel.level1,
  ...
  /// 모든 라우트 반환
  static Map<String, RouteDefinition> get allRoutes => Map.unmodifiable(_routes);
  ...
  static Map<String, RouteDefinition> getAccessibleRoutes(PermissionLevel userLevel) {
...
class _PlaceholderScreen extends StatelessWidget {
  ...
  const _PlaceholderScreen({required this.title, required this.subtitle, this.isError = false});
