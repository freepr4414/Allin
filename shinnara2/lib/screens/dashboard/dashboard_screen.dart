...
class DashboardScreen extends ConsumerWidget {
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            // 통계 카드들
            _buildStatsCards(context, dashboardStats, currencyFormatter),
  ...
  Widget _buildStatsCards(BuildContext context, dashboardStats, NumberFormat currencyFormatter) {
    ...
    return Column(
      children: [
        ...
        Row(
          children: [
            Expanded(
              child: DashboardPieChart(data: dashboardStats.seatTypeUsage, title: '좌석 유형별 사용률'),
            ),
          ],
        ),
        SizedBox(height: Responsive.getResponsivePadding(context)),
