class User {
  ...
  const User({required this.companyCode, required this.userCode, required this.password});

  Map<String, dynamic> toJson() {
    return {'companyCode': companyCode, 'userCode': userCode};
  }
}
...
class Message {
  ...
  factory Message.fromJson(Map<String, dynamic> json) {
    ...
    try {
      ...
      print('Timestamp 파싱 오류: ${e.toString()}, 기본값 사용');
      timestamp = DateTime.now();
    }
